...
{
    QRectF rectF;
    rectF.setX(radius*cos(angle*3.1415/180.0) - pointSize*2);
    rectF.setY(radius*sin(angle*3.1415/180.0) - pointSize/2.0);
...
void Clock::paintEvent(QPaintEvent *event)
{
    ...
    // 绘制小时线 （360度 / 12 = 30度）
    for (int i = 0; i < 12; ++i) {
        painter.drawLine(88, 0, 96, 0);//两个点连在一起
        painter.rotate(30.0);
    }
